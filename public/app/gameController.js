	...
	$scope.addConnectionContent = function(category, connection, count){
		...
		switch(count){
			...
			case 1:
				...
				break;
			case 2:
				$scope.content[category] = {header : connection.title, href: connection.href, picture : connection.picture, date : connection.date, 'sub-title-3' : connection['sub-title-3']};
				break;
		}
	};
